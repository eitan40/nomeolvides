...
public class Nomeolvides.DialogEtiqueta : Gtk.Dialog {
	protected Entry nombre_entry;
	public Etiqueta respuesta { get; protected set; }
	
	public DialogEtiqueta ( )
	{
		...
		var nombre_label = new Label.with_mnemonic (_("Tag Name") + ": ");
